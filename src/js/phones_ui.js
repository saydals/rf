...
export const UI_PHONES = {
    ...
    init: function() {
        ...
        $(`${this.background}, ${this.tabContainer}`).swipe( {
            ...
            // Do not let touchSwipe block native scrolling: the tab container
            // is a scrollable list (vertical sidebar in landscape, horizontal
            // bottom bar in portrait). With the defaults the plugin calls
            // preventDefault() on every touchmove, which makes the tab bar
            // feel unresponsive. See touchSwipe's preventDefaultEvents /
            // allowPageScroll options.
